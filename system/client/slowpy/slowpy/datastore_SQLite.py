...
class DataStore_SQLite(DataStore):
    schema_ts = '(timestamp INTEGER, channel STRING, value REAL, PRIMARY KEY(timestamp, channel))'
    schema_obj = '(channel STRING, value STRING, PRIMARY KEY(channel))'
    schema_objts = '(timestamp INTEGER, channel STRING, value STRING, PRIMARY KEY(timestamp, channel))'
