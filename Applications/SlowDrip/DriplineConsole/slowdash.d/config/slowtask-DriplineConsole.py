...
async def monitor_sensor_value_alerts():
    while not ctrl.is_stop_requested():
        ...
        await ctrl.aio_stream('SensorValues.DriplineConsole', SensorValuesTable())
...
async def monitor_heartbeat_alerts():
    while not ctrl.is_stop_requested():
        ...
        await ctrl.aio_stream('HeartBeats.DriplineConsole', HeartbeatsTable())
...
async def monitor_status_message_alerts():
    while not ctrl.is_stop_requested():
        ...
        await ctrl.aio_stream('StatusMessages.DriplineConsole', StatusMessagesTable())
...
async def sd_get_endpoint(endpoint:str, specifier:str=None, lockout_key:str=None):
    ...
    await ctrl.aio_stream('Replies.DriplineConsole', RepliesTable())
