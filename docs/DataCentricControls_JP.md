...
典型的には，コントロールを出すタスクがコントロールを Publish し，モニタがそれを感知したら，そのことを発出タスクに通知し，それ以降の責任はモニタが引き受けます．
...
- モニタがコントロール発行元に Acknowledged を送るようにしてもいい．これにより，送り出し側は，結果がモニタされたことを確認して安心できる．
